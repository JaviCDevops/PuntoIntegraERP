        ...
        <tr>
            <td align="center">
                ...
                <div style="margin-bottom: 20px;">
                    {{-- Usa asset() para producción, o la ruta directa si asset falla en local --}}
                    <img src="{{ asset('logo.webp') }}" alt="Logo Empresa" style="max-width: 150px; height: auto; display: block;">
                </div>
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            ...
                            <p style="margin: 0 0 20px 0; color: #4B5563; font-size: 16px; line-height: 1.6; text-align: center;">
                                Hola <strong>{{ $user->name }}</strong>, se ha creado exitosamente tu cuenta de acceso.
                            </p>
                            ...
                            <div style="background-color: #F3F4F6; border: 1px solid #E5E7EB; border-radius: 8px; padding: 25px; margin: 30px 0; text-align: center;">
                                ...
                                <div style="margin-bottom: 15px;">
                                    <span style="display: block; color: #9CA3AF; font-size: 14px;">Usuario</span>
                                    <span style="display: block; color: #1F2937; font-size: 18px; font-weight: bold;">{{ $user->email }}</span>
                                </div>
                                <div>
                                    <span style="display: block; color: #9CA3AF; font-size: 14px;">Contraseña</span>
                            ...
                            <p style="margin: 0; color: #6B7280; font-size: 13px; text-align: center; line-height: 1.5;">
                                <span style="color: #EF4444; font-weight: bold;">Importante:</span> Por seguridad, cambia tu contraseña al ingresar.
                            </p>
                        </td>
                    </tr>
                    <tr>
